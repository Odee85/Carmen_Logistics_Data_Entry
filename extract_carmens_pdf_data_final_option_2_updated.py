...
file_name = "option2_test_files\\TransactionReport-230710110034.pdf"
output_filename = "option2_test_files\\carmen_raw_data_202307_testing.csv"
...
def get_driver_name(formated_data):
    ...
    if formated_data[3].strip() == "Driver":
        driver_id = formated_data[3].strip() + formated_data[4].strip()
    elif formated_data[3].strip != "Driver":
        formated_data.insert(3, "Driver")
        driver_id = formated_data[3] + '2'
        formated_data.insert(4, '2')
    else:
        driver_id = formated_data[3]

    if driver_id == 'Driver1' or driver_id == 370:
        driver_name = "Kemario"
    else:
        driver_name = "Jarrette"
...
def get_driver_id(driver_name):
    ...
    if driver_name.upper() == "JARRETTE":
        vehicle_id = "370"
    elif driver_name.upper() == "ALEX":
        vehicle_id = "371"
    elif driver_name.upper() == "KEMARIO":
        vehicle_id = "372"
    else:
        vehicle_id == "None"
            ...
            try:
                if row_data[0] == 'ULSD' and len(formated_data) > 0:
                    ...
                    if len(formated_data) != 0:
                        ...
                        vehicle_id = get_driver_id(driver_name)
                        ...
                        vendor_name_components = formated_data[6: jurisdiction_index+1]
